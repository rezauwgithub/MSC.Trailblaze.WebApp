...
const ExistingInstancesTable = (props) => (
  ...
  <BootstrapTable data={props.existingInstancesTableData} keyField='compilerValue' cellEdit={ cellEditProp }>
    ...
    {props.existingInstancesTableHeaderColumns.map((col, index) => {
      return (
